...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function changePositionCatalogFilter() {
    ...
    if (catalogLeft && catalogRight && catalogSections) {
  ...
  // catalog slider
  var catalogSlider = document.querySelector('.catalog__slider .swiper');
  if (catalogSlider) {
    var myCatalogSlider = new Swiper(catalogSlider, {
      slidesPerView: 4,
      spaceBetween: 20,
      loop: true,
      navigation: {
